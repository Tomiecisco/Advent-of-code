    ...
    for i, j in enumerate(eng_sche):
        for k, l in enumerate(j):
            if l != '.' and not l.isdigit():
                # print("left",find_adj_l(i, k))
                # print("right",find_adj_r(i, k))
                # print("top",find_adj_u(i, k))
                # print("top left",findadj_ul(i, k))
                # print("top right",findadj_ur(i, k))
                # print("buttom",find_adj_b(i, k))
                # print("buttom left",findadj_bl(i, k))
                # print("buttom right",findadj_br(i, k))
